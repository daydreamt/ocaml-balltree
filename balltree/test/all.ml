...
let distances0, neighbours0 = Balltree.query_balltree bt0 (Tensor.reshape ~shape:[1;-1] (Tensor.of_float2 [| [| 0.; 1.;|] |])) 1;;
...
let distances2, _ = Balltree.query_balltree bt2 (Tensor.reshape ~shape:[-1;1] (Tensor.of_float2 [| [| 0.; 1.;|] |])) 1;;
...
let distances3, _ = Balltree.query_balltree bt3 (Tensor.reshape ~shape:[-1;1] query_point3) 3;;
...
let distances4, nn4 = Balltree.query_balltree bt4 (Tensor.reshape ~shape:[-1;1] (Tensor.of_float2 [| [| 0.; 0.;|] |])) 1;;
Stdio.print_endline (Float.to_string (List.hd_exn distances4));;
